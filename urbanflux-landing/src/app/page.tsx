...
export default function Home() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#112644] via-[#0A0F1C] to-[#0A0F1C]">
      ...
      {/* Main UI Container */}
      <div className="relative z-10 max-w-1xl mx-auto px-20 h-screen flex flex-col justify-center pointer-events-none">

        {/* Navigation / Header */}
        <nav className="absolute top-0 left-0 right-0 p-6 flex justify-between items-center max-w-7xl mx-auto w-full pointer-events-auto">
        ...
        <div className="max-w-2xl mt-20 ml-10 px-7 pointer-events-auto">
